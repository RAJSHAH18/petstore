  ...
  .user-name h3{
   ...
   <main>
    ...
    <table  class="products"><tbody>
      ...
      <tbody>
          <tr>
              <td><img src="images/brush.jpg" alt="an image about brush" width="140px" height="122px"></td></tr>
            <tr><th>Circle brush</th></tr>
            ...
            <tr><td><a href="cart1.php?id=<?php echo $pid?>&pname=<?php echo (basename($_SERVER['PHP_SELF'])); ?>"> <button>Add to cart</button></a>
                <a href="feedback.php?id=<?php echo $pid?>&pname=<?php echo (basename($_SERVER['PHP_SELF'])); ?>"><button>Feedback</button></a></td></tr>
          </tbody></table><br>
